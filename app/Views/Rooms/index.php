                ...
                <tbody>
                    <?php foreach($rooms as $key => $room) : ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $room['amenity_name'] ?></td>
                            <td><?php echo $room['bed_type_name'] ?></td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?php echo base_url('rooms/edit/'.$room['id']) ?>" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i> </a>
